  ...
  (function initTour() {
    ...
    const STEPS = [
      ...
      { target: '.pin-4', emoji: '🌙',
        ...
        th: '“บ้านพักใจ” มีเตียงนอน นั่งสมาธิ เช็คใจ และสมุดให้เขียนระบายความรู้สึก',
        en: 'The “Resting Home” — a bed, meditation, mood check-in, and a journal to let feelings out.' },
      { target: '.pin-5', emoji: '🎧',
      ...
      { target: '.pin-2', emoji: '🌳',
        ...
        th: '“สวนหย่อนใจ” ชวนเธอเดินเล่น มองท้องฟ้า เติมพลังจากโลกจริง',
        en: 'The “Chill Garden” — take a walk, look at the sky, recharge in the real world.' },
      { emoji: '🪧',
