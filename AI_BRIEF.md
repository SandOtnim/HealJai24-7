...
**รอบล่าสุด (ยังไม่ push — ดู TEAM-UPDATES.md):** พาทัวร์หน้าแรก + ดีไซน์พรีเมียม + ปุ่ม "พาทัวร์" · อินโทรเล่นครั้งเดียวต่อ session · เพลงเล่นต่อเนื่องข้ามหน้า + AJAX navigation ทุกห้อง (`nav.js`) · จุดเช็คใจรายวัน save + กราฟแนวโน้ม · เปลี่ยนชื่อเกาะ+ห้องเป็นธีม "ใจ" (เกาะฮีลใจ/ศาลฮีลใจ/พิพิธภัณฑ์จัดแสดงใจ/ห้องนอนพักใจ/ลานสบายใจ/คาเฟ่รวมใจ)
...
- **ระบบหลังบ้านให้ทีมเช็ค/แก้คำเซียมซี + ไพ่ได้**

**ห้องนอน / ห้องนอนพักใจ**
- เสียงธรรมชาติ + เพลงหลับลึก · สมาธิหรี่จอ + countdown มีเสียงตอนจบ · จดบันทึก date stamp + gratitude journal · น้องแมว "หิว" (timer) · โต๊ะทำงาน แมวเดิน + เปิดปิดไฟ

**ห้องกิจกรรม / ลานสบายใจ**
